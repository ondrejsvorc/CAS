...
Poslední týden + 10 hodin predikce

```{r}
plot(f_iv, include = 7*24, main = "Predikce (ARIMA, iv)",xlab = "Čas", ylab = "Počet jízd")
plot(f_vi, include = 7*24, main = "Predikce (ARIMAX, vi)", xlab = "Čas", ylab = "Počet jízd")
```
